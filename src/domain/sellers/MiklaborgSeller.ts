...
export default class MiklaborgSeller extends AbstractSeller implements Seller {
  ...
  public feesTaken(price: number, hoursWorked: number): Fee[] {
    return [
      new SalesPercentageFee('aðstoðina', price, 0.0434, 489_800),
      new FlatFee('gagnaöflun', 37200, 'Gagnaöflun'),
      new FlatFee('aðstoð og/eða skjalafrágang', 310_000, 'Skjalafrágangur'),
    ];
  }
}
